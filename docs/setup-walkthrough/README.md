...
| A2 | login page | `images/02-login.png` | pending | 1 |
| B1 | login form | `images/03-login-form.png` | pending | 1 |
| B2 | dashboard after login | `images/04-dashboard.png` | pending | 1 |
...
| C3 | vulnerabilities table (OpenCVE-like columns) | `images/08-vulns-table.png` | pending | 1 |
| C4 | vulnerability detail (description, scoring, affected, refs, history) | `images/09-vuln-detail.png` | pending | 1 |
| C5 | advanced search / filters / saved view | `images/10-search-views.png` | pending | 1 |
...
| F2 | app shell/nav | `images/19-app-shell.png` | pending | 1 |
