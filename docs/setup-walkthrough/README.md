...
| B3 | config/env UI или документированный конфиг без секретов | `images/05-config.png` | **ready** | 2 |
| C1 | sync settings before | `images/06-sync-before.png` | **ready** | 2 |
| C2 | sync state/job after | `images/07-sync-after.png` | **ready** | 2 |
